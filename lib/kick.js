...
// ملاحظة مهمة: Kick يشترط أن يكون التطبيق (client) مسجّل ببوت رسمي عشان type:'bot' يشتغل،
// وإرسالها باسم البوت لازم يستخدم توكن حساب البوت نفسه (senderUser = البوت) وليس توكن صاحب القناة.
